...
Run:  python -m src.viz.publish_hf --data-dir data/viz --repo <user>/autoscientist-chartqa-dataset
...
def main() -> None:
    ...
    if not dd:
        raise SystemExit(f"no examples found under {args.data_dir} (run src.viz.build_dataset first)")
