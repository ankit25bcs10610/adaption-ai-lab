...
**Dataset lineage — single source of truth.** The published open dataset (HF + Kaggle) is **6,522 rows**
(6,279 `train`/`val`/`test` + 243 `test_novel`, across 7,315 unique tools); the platform-graded runs below
