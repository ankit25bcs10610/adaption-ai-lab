...
Run:  python -m autoscientist_toolcaller.viz.train_adaption --data data/viz/train_tab.jsonl --dry-run
"""
...
def main() -> None:
    ...
    if not os.path.exists(args.data):
        raise SystemExit(f"{args.data} not found — run: python -m autoscientist_toolcaller.viz.build_dataset")
