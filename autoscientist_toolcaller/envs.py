...
Outputs canonical function-calling examples (tools/query/answer/meta) compatible with autoscientist_toolcaller.format_utils,
plus DPO pairs compatible with autoscientist_toolcaller.build_preference. Pure stdlib; seeded; offline-testable.
"""
