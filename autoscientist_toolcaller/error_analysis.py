...
Usage:
  python -m autoscientist_toolcaller.error_analysis --model <id> [--adapter path] --data data/out/test.jsonl
"""
...
def write_reports(result: Dict[str, Any], out_dir: str) -> None:
    ...
    # predictions.jsonl feeds the confusion matrix in autoscientist_toolcaller.eval_report
